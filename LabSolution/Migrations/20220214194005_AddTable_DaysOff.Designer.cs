...
namespace LabSolution.Migrations
{
    ...
    [Migration("20220214194005_AddTable_DaysOff")]
    partial class AddTable_DaysOff
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabSolution.Models.AppConfig", b =>
                {
                    ...
                    b.HasIndex(new[] { "Key" }, "IX_AppConfig_Key")
                        .IsUnique()
            ...
            modelBuilder.Entity("LabSolution.Models.DaysOff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("IsHolidayDeactivated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LabSolution.Models.OpeningHours", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "DayOfWeek" }, "IX_OpeningHours_DayOfWeek")
                        .IsUnique();
